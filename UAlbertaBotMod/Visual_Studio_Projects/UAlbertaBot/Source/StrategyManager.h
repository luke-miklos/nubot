...
public:
	...
	enum { TerranMarineRush=0, TerranMedicRush=1, TerranWraithRush=2, NumTerranStrategies=3 };
	enum { ZergZerglingRush=0, ZergLurkerRush=1, ZergMutaliskRush=2, NumZergStrategies=3 };
