...
void NubotAIModule::onSendText(std::string text)
{
...
void NubotAIModule::onReceiveText(BWAPI::Player* player, std::string text)
{
  // Parse the received text
  Broodwar->printf("%s said '%s'", player->getName().c_str(), text.c_str());
}

void NubotAIModule::onPlayerLeft(BWAPI::Player* player)
{
...
void NubotAIModule::onNukeDetect(BWAPI::Position target)
{
...
void NubotAIModule::onUnitDiscover(BWAPI::Unit* unit)
{/*
  if ( !Broodwar->isReplay() )
    Broodwar->sendText("A %s [%x] has been discovered at (%d,%d)",unit->getType().getName().c_str(),unit,unit->getPosition().x(),unit->getPosition().y());
*/}

void NubotAIModule::onUnitEvade(BWAPI::Unit* unit)
{/*
  if ( !Broodwar->isReplay() )
    Broodwar->sendText("A %s [%x] was last accessible at (%d,%d)",unit->getType().getName().c_str(),unit,unit->getPosition().x(),unit->getPosition().y());
*/}

void NubotAIModule::onUnitShow(BWAPI::Unit* unit)
{/*
  if ( !Broodwar->isReplay() )
    Broodwar->sendText("A %s [%x] has been spotted at (%d,%d)",unit->getType().getName().c_str(),unit,unit->getPosition().x(),unit->getPosition().y());
*/}

void NubotAIModule::onUnitHide(BWAPI::Unit* unit)
{/*
  if ( !Broodwar->isReplay() )
    Broodwar->sendText("A %s [%x] was last seen at (%d,%d)",unit->getType().getName().c_str(),unit,unit->getPosition().x(),unit->getPosition().y());
*/}

void NubotAIModule::onUnitCreate(BWAPI::Unit* unit)
{/*
  if ( !Broodwar->isReplay() )
...
void NubotAIModule::onUnitDestroy(BWAPI::Unit* unit)
{/*
  if ( !Broodwar->isReplay() )
    Broodwar->sendText("A %s [%x] has been destroyed at (%d,%d)",unit->getType().getName().c_str(),unit,unit->getPosition().x(),unit->getPosition().y());
*/}

void NubotAIModule::onUnitMorph(BWAPI::Unit* unit)
{/*
  if ( !Broodwar->isReplay() )
...
void NubotAIModule::onUnitRenegade(BWAPI::Unit* unit)
{/*
  if (!Broodwar->isReplay())
    Broodwar->sendText("A %s [%x] is now owned by %s",unit->getType().getName().c_str(),unit,unit->getPlayer()->getName().c_str());
*/}

void NubotAIModule::onSaveGame(std::string gameName)
{
  Broodwar->printf("The game was saved to \"%s\".", gameName.c_str());
}

void NubotAIModule::onUnitComplete(BWAPI::Unit *unit)
{/*
