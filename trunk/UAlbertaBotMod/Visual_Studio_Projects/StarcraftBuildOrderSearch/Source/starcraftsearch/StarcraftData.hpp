...
class StarcraftData {
	...
	void addActions(BWAPI::Race & r)
	{
		...
		else if (r == BWAPI::Races::Terran)
		{
         ...
         actions.push_back(StarcraftAction(BWAPI::UnitTypes::Terran_Siege_Tank_Siege_Mode, actions.size()));
         actions.push_back(StarcraftAction(BWAPI::UnitTypes::Terran_Ghost, actions.size()));
         ...
         actions.push_back(StarcraftAction(BWAPI::UnitTypes::Terran_Science_Vessel, actions.size()));
         actions.push_back(StarcraftAction(BWAPI::UnitTypes::Terran_Dropship, actions.size()));
         actions.push_back(StarcraftAction(BWAPI::UnitTypes::Terran_Battlecruiser, actions.size()));
       //actions.push_back(StarcraftAction(BWAPI::UnitTypes::Terran_Vulture_Spider_Mine, actions.size()));
       //actions.push_back(StarcraftAction(BWAPI::UnitTypes::Terran_Nuclear_Missile, actions.size()));
         actions.push_back(StarcraftAction(BWAPI::UnitTypes::Terran_Firebat, actions.size()));
       //actions.push_back(StarcraftAction(BWAPI::UnitTypes::Spell_Scanner_Sweep, actions.size()));
         actions.push_back(StarcraftAction(BWAPI::UnitTypes::Terran_Valkyrie, actions.size()));
       //actions.push_back(StarcraftAction(BWAPI::UnitTypes::Terran_Civilian, actions.size()));
         actions.push_back(StarcraftAction(BWAPI::UnitTypes::Terran_Comsat_Station, actions.size()));
         actions.push_back(StarcraftAction(BWAPI::UnitTypes::Terran_Nuclear_Silo, actions.size()));
         actions.push_back(StarcraftAction(BWAPI::UnitTypes::Terran_Control_Tower, actions.size()));
         actions.push_back(StarcraftAction(BWAPI::UnitTypes::Terran_Science_Facility, actions.size()));
         actions.push_back(StarcraftAction(BWAPI::UnitTypes::Terran_Covert_Ops, actions.size()));
         actions.push_back(StarcraftAction(BWAPI::UnitTypes::Terran_Physics_Lab, actions.size()));
       ...
       //actions.push_back(StarcraftAction(BWAPI::TechTypes::Spider_Mines, actions.size()));
         actions.push_back(StarcraftAction(BWAPI::TechTypes::Lockdown, actions.size()));
         actions.push_back(StarcraftAction(BWAPI::TechTypes::EMP_Shockwave, actions.size()));
       //actions.push_back(StarcraftAction(BWAPI::TechTypes::Scanner_Sweep, actions.size()));
         actions.push_back(StarcraftAction(BWAPI::TechTypes::Tank_Siege_Mode, actions.size()));
       //actions.push_back(StarcraftAction(BWAPI::TechTypes::Defensive_Matrix, actions.size()));
       //actions.push_back(StarcraftAction(BWAPI::TechTypes::Irradiate, actions.size()));
       //actions.push_back(StarcraftAction(BWAPI::TechTypes::Yamato_Gun, actions.size()));
         actions.push_back(StarcraftAction(BWAPI::TechTypes::Cloaking_Field, actions.size()));
       //actions.push_back(StarcraftAction(BWAPI::TechTypes::Personnel_Cloaking, actions.size()));
       //actions.push_back(StarcraftAction(BWAPI::TechTypes::Nuclear_Strike, actions.size()));
		}
       ...
       //actions.push_back(StarcraftAction(BWAPI::UnitTypes::Zerg_Larva, actions.size()));
       //actions.push_back(StarcraftAction(BWAPI::UnitTypes::Zerg_Egg, actions.size()));
         actions.push_back(StarcraftAction(BWAPI::UnitTypes::Zerg_Ultralisk, actions.size()));
       //actions.push_back(StarcraftAction(BWAPI::UnitTypes::Zerg_Broodling, actions.size()));
       ...
       //actions.push_back(StarcraftAction(BWAPI::UnitTypes::Zerg_Cocoon, actions.size()));
